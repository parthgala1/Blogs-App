    ...
    return (
        <>
            <div className='h-screen w-full flex justify-center items-center flex-col bg-gradient-to-b via-red-100 from-white to-white'>
                ...
                <h1 className='text-3xl font-bold font-montserrat bg-gradient-to-r from-red-700 to-red-300 bg-clip-text text-transparent'>
                    -- 404 PAGE NOT FOUND --
                </h1>
                <p className='text-montserrat text-lg font-medium bg-gradient-to-r from-red-300 to-red-700 bg-clip-text text-transparent'>Are Best Minds are at work!!</p>
            </div >
            <Contact />
        </>
    )
